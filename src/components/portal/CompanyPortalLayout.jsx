...
const notifications = [
  {
    ...
    message: "A new student intern has been assigned to your company.",
    time: "2 hrs ago",
    unread: true,
  },
  {
    ...
    message: "You have pending intern evaluations to complete.",
    time: "1 day ago",
    unread: true,
  },
  {
    ...
    message: "A student internship application is waiting for your review.",
    time: "2 days ago",
    unread: false,
  },
];
        ...
        >
          ...
          >
            ...
            <div className="ml-3">
              ...
              <p className="text-xs text-slate-400">Company Environment</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex items-center min-w-0">
              ...
              <div className="min-w-0">
                <p className="text-sm text-slate-400">Company Portal</p>
              ...
              <div className="relative" ref={profileMenuRef}>
                ...
                >
                  ...
                  <div className="hidden sm:block text-left">
                    <p className="text-sm font-semibold">ABC Corp</p>

                    <p className="text-xs text-slate-400">Company Supervisor</p>
                  </div>
                ...
                {isProfileOpen && (
                  ...
                  >
                    ...
                    >
                      <p className="text-sm font-bold">ABC Corp</p>

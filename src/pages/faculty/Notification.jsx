  ...
  const [notifications, setNotifications] = useState([
    {
      ...
      message:
        "John Doe has submitted a new internship application for your review.",
      type: "Application",
      time: "2 hrs ago",
      read: false,
    },
    {
      ...
      message:
        "A student has submitted a new internship document that requires your review.",
      type: "Document",
      time: "5 hrs ago",
      read: false,
    },
    ...
    },
    {
      ...
      message:
        "Student evaluations for the current internship period are ready for completion.",
      type: "Evaluation",
      time: "2 days ago",
      read: true,
    },
    {
      ...
      message:
        "The internship application for Sarah Lee has been successfully approved.",
      type: "Application",
      time: "3 days ago",
      read: true,
    },
          ...
          >
            <div>
              ...
              <p className={`text-xs mt-1 ${mutedClass}`}>
                View and manage your recent faculty notifications.
              </p>
            </div>

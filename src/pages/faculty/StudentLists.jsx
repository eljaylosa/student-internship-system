      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          ...
          {filteredStudents.length > 0 ? (
                    ...
                    >
                      ...
                      <td className="px-4 py-5 border-b">
                        <div>
                          ...
                          <p
                            className={`text-[10px] mt-1 truncate max-w-[240px] ${mutedClass}`}
                          >
                            {student.email}
                          </p>
                        </div>
            ...
            <div
              className={`mx-4 sm:mx-5 mb-5 border rounded-xl py-16 text-center ${
                darkMode
          ...
          >
            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                ...
                >
                  <p
                    className={`text-[10px] uppercase tracking-wide font-bold mb-2 ${mutedClass}`}
                  >
                    Status
                  </p>
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <p
                      className={`text-[10px] uppercase tracking-wide font-bold ${mutedClass}`}
                    >
                      Internship Progress
                    </p>
